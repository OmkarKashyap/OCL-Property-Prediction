...
class MultiObjectDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if out["mask"].shape != (self.max_num_objects, 1, self.height, self.width):
            out_mask_shape = out["mask"].shape
            print(f"out['mask'].shape {out_mask_shape} and (self.max_num_objects, 1, self.height, self.width): {(self.max_num_objects, 1, self.height, self.width)}")
